"""Checkpoint-compatible Diffusion Planner network.

This module is a focused research port of the model architecture at upstream commit
``a3a621f0b724c5fa6447f7a2fbaf9e0387bd35df``.  It deliberately excludes nuPlan
data extraction, planner wrappers, and classifier guidance.
"""
